                    ...
                    <form id="update-form" action="{{ route('letter.update',$letter->id) }}" method="post">
                        ...
                        <div class="row alert alert-info">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_surat" id="" class="form-control" placeholder=""
                                        value="{{ $letter->nomor_surat  }}" aria-describedby="helpId">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="official_id" class="form-control" aria-describedby="helpOfficial">
                                    ...
                                    <option value="{{ $item->id }}"
                                        {{ $item->id == $letter->official_id ? 'selected' : '' }}>
                                        {{ $item->nama_pejabat }}</option>
                                    @empty
                                    <option value="" selected disabled>Tidak ada pejabat, silahkan tambahkan terlebih
                                        dahulu</option>
                                    @endforelse
                                </select>
                                <small id="helpOfficial" class="text-white">Orang yang bertanda tangan pada
                                    surat</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_lengkap" class="form-control" placeholder=""
                                        value="{{ $letter->nama_lengkap }}" aria-describedby="helpId">
                                    <small id="helpId" class="text-muted">Nama Lengkap sesuaikan dengan KTP</small>
                                </div>
                                <div class="form-group">
                                    <label for="nik">Nomor Induk Keluarga</label>
                                    <input type="number" name="nik" id="nik" class="form-control" placeholder=""
                                        value="{{ $letter->nik }}" aria-describedby="helpNIK">
                                    <small id="helpNIK" class="text-muted">NIK tercantum pada KTP atau KK</small>
                                </div>
                                <div class="form-group">
                                    <label for="tempat_lahir">Tempat Lahir</label>
                                    <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control"
                                        value="{{ $letter->tempat_lahir }}" placeholder=""
                                        aria-describedby="helptempat_lahir">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_kawin" class="form-control" aria-describedby="helpJK">
                                        ...
                                        <option value="Kawin" {{ $letter->status_kawin == 'Kawin' ? 'selected' : '' }}>
                                            Kawin</option>
                                        <option value="Belum Kawin"
                                            {{ $letter->status_kawin == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin
                                        </option>
                                        <option value="Cerai Hidup"
                                            {{ $letter->status_kawin == 'Cerai Hidup' ? 'selected' : '' }}>Cerai Hidup
                                        </option>
                                        <option value="Cerai Mati"
                                            {{ $letter->status_kawin == 'Cerai Mati' ? 'selected' : '' }}>Cerai Mati
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nomor_hp" id="nomor_hp" class="form-control"
                                        value="{{ $letter->nomor_hp }}" placeholder="" aria-describedby="helpNomor">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_kelamin" class="form-control" aria-describedby="helpJK">
                                        ...
                                        <option value="Laki-laki"
                                            {{ $letter->jenis_kelamin == 'Laki-laki' ? 'selected' : '' }}>Laki-laki
                                        </option>
                                        <option value="Perempuan"
                                            {{ $letter->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control"
                                        value="{{ $letter->tanggal_lahir }}" placeholder=""
                                        aria-describedby="helptanggal_lahir">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="agama" class="form-control" aria-describedby="helpAgama">
                                        ...
                                        <option value="Islam" {{ $letter->agama == 'Islam' ? 'selected' : '' }}>Islam
                                        </option>
                                        <option value="Hindu" {{ $letter->agama == 'Hindu' ? 'selected' : '' }}>Hindu
                                        </option>
                                        <option value="Budha" {{ $letter->agama == 'Budha' ? 'selected' : '' }}>Budha
                                        </option>
                                        <option value="Kristen" {{ $letter->agama == 'Kristen' ? 'selected' : '' }}>
                                            Kristen</option>
                                        <option value="Katolik" {{ $letter->agama == 'Katolik' ? 'selected' : '' }}>
                                            Katolik</option>
                                        <option value="Protestan" {{ $letter->agama == 'Protestan' ? 'selected' : '' }}>
                                            Protestan</option>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="dusun" id="dusun" aria-describedby="helpDusun">
                                        <option>Pilih Dusun</option>
                                        <option value="Dusun Sidodadi"
                                            {{ $letter->dusun == 'Dusun Sidodadi' ? 'selected' : '' }}>Dusun Sidodadi
                                        </option>
                                        <option value="Dusun Sidoagung"
                                            {{ $letter->dusun == 'Dusun Sidoagung' ? 'selected' : '' }}>Dusun Sidoagung
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pekerjaan" id="pekerjaan" class="form-control"
                                        value="{{ $letter->pekerjaan }}" placeholder=""
                                        aria-describedby="helpPEKERJAAN">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keperluan_sk" id="keperluan_sk" class="form-control"
                                        ...
                                        aria-describedby="helpKeperluan">
                        ...
                        <div class="form-check mb-4">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="cetak" id="" value="cetak"
                                    checked>
                                Cetak Surat
                            </label>
                        </div>
